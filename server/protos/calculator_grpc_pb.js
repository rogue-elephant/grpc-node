...
function deserialize_calculator_NthFibonacciRequest(buffer_arg) {
  return protos_calculator_pb.NthFibonacciRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_calculator_NthFibonacciResponse(arg) {
  if (!(arg instanceof protos_calculator_pb.NthFibonacciResponse)) {
    throw new Error('Expected argument of type calculator.NthFibonacciResponse');
  }
  return Buffer.from(arg.serializeBinary());
}
...
nthFibonacci: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: protos_calculator_pb.NthFibonacciRequest,
    responseType: protos_calculator_pb.NthFibonacciResponse,
    requestSerialize: serialize_calculator_NthFibonacciRequest,
